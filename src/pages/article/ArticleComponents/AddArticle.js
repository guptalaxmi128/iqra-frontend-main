...
const AddArticle = (props) => {
    ...
    const handleSubmit = () => {
        try {
            ...
            formData.append('wNCategory', article.wNCategory);
            formData.append('timeStamp', article.timeStamp);
            formData.append('heading', article.heading);
            formData.append('rating', 0);
            formData.append('tags', tags);
            formData.append('prelims', article.prelims);
            formData.append('mains', article.mains);
            formData.append('subject', subjects);
            formData.append('dataFromEditor', editor);
            formData.append('questionHeading', article.questionHeading);
            formData.append('question', article.question);
            formData.append('options', optionsData);
            formData.append('answer', article.answer);
            formData.append('source', article.source);
            console.log(formData);
            dispatch(addArticle(formData));
            setArticlesTable([...articlesTable, formData]);
            setArticle({
                wNCategory: '',
                timeStamp: null,
                heading: '',
