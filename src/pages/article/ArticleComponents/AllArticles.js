...
const handleSelectAllClick = (event) => {
    if (event.target.checked) {
        const newSelecteds = articlesTable.map((n) => n.id);
...
const filteredUsers = applySortFilter(articlesTable, getComparator(order, orderBy), filterName);
